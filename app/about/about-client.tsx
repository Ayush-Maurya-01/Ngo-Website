          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-10">
            {[1, 2, 3].map((member) => (
              <div key={member} className="group cursor-pointer">
                <div className="relative w-48 h-48 mx-auto rounded-full overflow-hidden mb-6 shadow-lg group-hover:shadow-2xl transition-all duration-300 ring-4 ring-slate-100 group-hover:ring-primary-200">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-1 group-hover:text-primary-600 transition-colors">{t("about_team_name")}</h3>
                <p className="text-primary-600 font-medium">{t("about_team_role")}</p>
              </div>
            ))}
          </div>
        </div>
